...
public class FactoryController {
    ...
    public static Object controller(String nombre, EntityManager entityManager) {
        ...
        switch (nombre) {
            ...
            case "Prestadoras": controller = new EmpresasController(new RepositorioPrestadoras(entityManager), new RepositorioMiembros(entityManager), new RepositorioOrganismos(entityManager)); break;
